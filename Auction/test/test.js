...
contract('AuctionContract', function (accounts) {
  ...
  it("Should NOT allow non owner to reveal winners", function() {
    /**********
    TASK 4: Call revealWinners from account 1 (non-owner account)
    ***********/
  ...
  it("Should set winners", function() {
    ...
    ***********/
    return auctionInstance.register({from:accounts[2]}).then(function(result) {
      ...
      ***********/
      /*<CODE HERE>*/assert.notEqual(result, "0x0000000000000000000000000000000000000000", "If winner address is the default address");
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
      /*<CODE HERE>*/assert.notEqual(result, "0x0000000000000000000000000000000000000000", "If winner address is NOT the default address");

      /**********
      TASK 18: Call winners function from account 3 to get the winner of item id 2
      ***********/
      return auctionInstance.winners(2, {from:accounts[3]})}).then(function(result) {
      /**********
